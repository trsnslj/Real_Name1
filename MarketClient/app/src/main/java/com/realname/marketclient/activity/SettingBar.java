...
public class SettingBar extends FrameLayout {
    ...
    public SettingBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 图标尺寸设置
        if (array.hasValue(R.styleable.SettingBar_bar_leftIconSize)) {
            setLeftIconSize(array.getDrawable(R.styleable.SettingBar_bar_leftIconSize));
        }
    ...
    public SettingBar setLeftIconSize(Drawable drawable) {
        drawable.setBounds(2,2,100,100);
